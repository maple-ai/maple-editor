 ...
 * {@link module:image/imageinsert/ui/imageinsertpanelview~ImageStandardInsertPanelView}.
 *
...
export function prepareIntegrations( editor ) {
	...
	const PREDEFINED_INTEGRATIONS = {
		'insertImageStandardViaUrl': createLabeledInputView( editor.locale )
	};
	...
	// Creates integrations object of valid views to pass it to the ImageStandardInsertPanelView.
