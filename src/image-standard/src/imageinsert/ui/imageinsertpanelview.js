...
import ImageStandardInsertFormRowView from './imageinsertformrowview';
 ...
 *
 * See {@link module:image/imageinsert/ui/imageinsertpanelview~ImageStandardInsertPanelView}.
 *
 * @extends module:ui/view~View
 */
export default class ImageStandardInsertPanelView extends View {
	/**
	 * Creates a view for the dropdown panel of {@link module:image/imageinsert/imageinsertui~ImageStandardInsertUI}.
	 *
	...
	constructor( locale, integrations ) {
		...
		if ( integrations ) {
			for ( const [ integration, integrationView ] of Object.entries( integrations ) ) {
				if ( integration === 'insertImageStandardViaUrl' ) {
		...
		this.setTemplate( {
			...
			children: [
				...this._integrations,
				new ImageStandardInsertFormRowView( locale, {
					children: [
