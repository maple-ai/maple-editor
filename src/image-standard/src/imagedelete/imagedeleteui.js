...
/**
 * @module image/imagedelete/imagedeleteui
 */
 ...
 */
export default class ImageStandardDeleteUI extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
	...
	_createButton() {
		...
		editor.ui.componentFactory.add( 'ImageStandardDelete', locale => {
			const command = editor.commands.get( 'ImageStandardDelete' );
			const view = new ButtonView( locale );

			view.set( {
				label: t( 'Delete ImageStandard' ),
			...
			this.listenTo( view, 'execute', () => {
				...
				editor.model.change( writer => {
					...
					writer.remove( selectedImageStandard );
				});
			} );
			return view;
		} );
