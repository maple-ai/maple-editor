...
/**
 * @module file/fileinsert/ui/fileinsertformrowview
 */

import { View } from 'ckeditor5/src/ui';

import '../../../theme/fileinsertformrowview.css';

/**
 * The class representing a single row in a complex form,
 * used by {@link module:file/fileinsert/ui/fileinsertpanelview~FileInsertPanelView}.
 *
 * **Note**: For now this class is private. When more use cases appear (beyond `ckeditor5-table` and `ckeditor5-file`),
 * it will become a component in `ckeditor5-ui`.
 *
 * @private
 * @extends module:ui/view~View
 */
export default class FileUploadFormRowView extends View {
	/**
