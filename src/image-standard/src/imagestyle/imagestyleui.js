...
import ImageStandardStyleEditing from './imagestyleediting';
 ...
 *
 * It registers buttons corresponding to the {@link module:image/image~ImageStandardConfig#styles} configuration.
 * It also registers the {@link module:image/imagestyle/utils~DEFAULT_DROPDOWN_DEFINITIONS default drop-downs} and the
 * custom drop-downs defined by the developer in the {@link module:image/image~ImageStandardConfig#toolbar} configuration.
 *
 * @extends module:core/plugin~Plugin
 */
export default class ImageStandardStyleUI extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
	...
	init() {
		...
		const definedStyles = translateStyles(
			plugins.get( 'ImageStandardStyleEditing' ).normalizedStyles,
	 ...
	 *
	 * @private
	 * @param {module:image/imagestyle/imagestyleui~ImageStandardStyleDropdownDefinition} dropdownConfig
	 * @param {Array.<module:image/imagestyle~ImageStandardStyleOptionDefinition>} definedStyles
	 */
	 ...
	 *
	 * @private
	 * @param {module:image/imagestyle~ImageStandardStyleOptionDefinition} buttonConfig
	 */
...
//
// @param {Array.<module:image/imagestyle~ImageStandardStyleOptionDefinition|
// module:image/imagestyle/imagestyleui~ImageStandardStyleDropdownDefinition>} styles
// @param {Object.<String,String>} titles
//
// @returns {Array.<module:image/imagestyle~ImageStandardStyleOptionDefinition|module:image/imagestyle/imagestyleui~ImageStandardStyleDropdownDefinition>}
 ...
 *
 * This definition can be implemented in the {@link module:image/image~ImageStandardConfig#toolbar image toolbar configuration}
 ...
 *		} );
 *
 * **Note:** At the moment it is possible to populate the custom drop-down with only the buttons registered by the `ImageStandardStyle` plugin.
 *
 ...
 * Each of the buttons has to be one of the {@link module:image/image~ImageStandardConfig#styles default image style buttons}
 * or to be defined as the {@link module:image/imagestyle~ImageStandardStyleOptionDefinition image styling option}.
 *
 ...
 *
 * @typedef {Object} module:image/imagestyle/imagestyleui~ImageStandardStyleDropdownDefinition
 */
